...
class InMemoryOfferPerformanceTrackerTest {
    ...
    fun `record agrega una oferta y expone su timing`() {
        tracker.record(OfferTiming(parseMillis = 3.0, totalMillis = 12.0))
